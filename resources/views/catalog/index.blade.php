                            ...
                            <div class="p-3 md:p-6">
                                ...
                                <div class="flex items-center gap-2 mb-2 md:mb-3">
                                    <div class="flex items-center gap-1 text-amber-500">
                                        <svg class="w-3 h-3 md:w-3.5 md:h-3.5 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                                        <span class="text-[9px] md:text-[10px] font-black">{{ $package->reviews_avg_rating ? number_format($package->reviews_avg_rating, 1) : '5.0' }}</span>
                                    </div>
                                    <div class="w-1 h-1 rounded-full bg-slate-300"></div>
                                    <span class="text-[9px] md:text-[10px] font-bold text-slate-500">{{ $package->order_items_sum_quantity ? number_format($package->order_items_sum_quantity, 0, ',', '.') : '0' }} Terjual</span>
                                </div>
